...
console.log(new Data().data.vision); 

let vison = (new Data().data.awards[0].id);
...
<link rel="stylesheet" href="assets/icon/css/bootstrap.min.css" type="text/css"/>
    ...
    <link rel="stylesheet" href="assets/icon/css/colors/red.css" type="text/css"></link>
        ...
        <div id="content" class="no-bottom no-top">
            ...
            <section id="subheader" class="text-light" data-bgimage="url(assets/icon/images/background/10.jpg)" data-stellar-background-ratio=".2">
            ...
            <section id="section-side" class="side-bg no-padding" data-bgcolor="#f9f9f9">
                <div class="image-container col-md-7 pull-left d-block d-sm-none d-md-block">
                    <div class="background-image" data-bgimage="url(assets/icon/images/background/11.jpg)"></div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="profile_pic text-center">
                                <figure class="picframe sc-icon mb20">
                                    ...
                                    <img src={new Data().data.team[4].photo.url} class="img-fluid" alt=""/>
                                </figure>
        ...
        {/* <script type="text/javascript">
            setTimeout(function (){
                ...
                var scriptSrcs = new Array(["assets/icon/js/jquery.min.js", "assets/icon/js/bootstrap.min.js"]);
                scriptSrcs.map(function (src){
            ...
            <script src="assets/icon/js/jquery.min.js" defer></script>
        <script src="assets/icon/js/bootstrap.min.js" defer></script>
        <script src="assets/icon/js/jquery.isotope.min.js" defer></script>
        <script src="assets/icon/js/easing.js" defer></script>
        <script src="assets/icon/js/owl.carousel.js" defer></script>
        <script src="assets/icon/js/jquery.countTo.js" defer></script>
        <script src="assets/icon/js/wow.min.js" defer></script>
        <script src="assets/icon/js/jquery.magnific-popup.min.js" defer></script>
        <script src="assets/icon/js/enquire.min.js" defer></script>
        <script src="assets/icon/js/jquery.stellar.min.js" defer></script>
        <script src="assets/icon/js/jquery.plugin.js" defer></script>		
		<script src="assets/icon/js/jquery.easeScroll.js" defer></script>
        <script src="assets/icon/js/designesia.js" defer></script>
        <script src="assets/icon/js/validation.js" defer></script>
